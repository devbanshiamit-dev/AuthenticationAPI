...
namespace Registration_System.Services
{
    public class AuthenticationService : IAuthenticationService
    {
        ...
        public async Task<ResponseDTO> LoginAsync(LoginDTO Dto)
        {
            ...
            if (!PasswordHasher.VerifyPassword(ExistingUser.PasswordHash, Dto.Password))
            {
        ...
        public async Task ChangePasswordAsync(ChangePasswordDTO dto, int userId)
        {
            ...
            if (!PasswordHasher.VerifyPassword(user.PasswordHash, dto.CurrentPassword))
            {
        ...
        // Internal services
        private async Task<ResponseDTO> GetAllTokensAsync(User user)
        {
